...
실제 구현은 scripts/piper/inference/piper_infer_gui.py에 있다. 그 파일은 같은 디렉터리의
...
_INFERENCE_DIR = pathlib.Path(__file__).resolve().parent.parent / "scripts" / "piper" / "inference"

...
SmolVLA 쪽 절차는 `method.md`와 `smolvla_finetuning.md`를
...
SmolVLA의 bf16 근거는 `smolvla_finetuning.md`의 "BF16 mixed precision"
...
`smolvla_finetuning.md`의 "BF16 mixed precision" 절 말미에 정리돼 있다.

...
실행: python -m pytest scripts/tests/tasks/erase_shape/evaluation/test_hil_clutch_mock.py -q
"""
...
RUNTIME_DIR = SCRIPTS_DIR / "tasks" / "erase_shape" / "runtime"
...
def test_runner_source_guards_next_action_when_intervening():
    ...
    src = (INFERENCE_DIR / "piper_infer_runner.py").read_text()

...
lerobot-train \
  ...
  --output_dir=/home/ugrp43/UGRP/lerobot_robot_piper/outputs/train/pick_up_the_eraser_and_erase_the_shape/smolvla_hamlet_pickup_prompt_315_stride35_v3 \
  --job_name=smolvla_hamlet_pickup_prompt_315_stride35_v3 \
  --batch_size=8 \
  --num_workers=2 \
  --steps=168000 \
  --log_freq=100 \
  ...
  --wandb.run_id=smolvla_hamlet_pickup_prompt_315_stride35_v3 \
  --wandb.disable_artifact=true

echo "[DONE] smolvla_hamlet_pickup_prompt_315_stride35_v3 완료."

...
lerobot-train \
  ...
  --output_dir=/home/ugrp43/UGRP/lerobot_robot_piper/outputs/train/pick_up_the_eraser_and_erase_the_shape/smolvla_hamlet_pickup_prompt_315_stride35_v2 \
  --job_name=smolvla_hamlet_pickup_prompt_315_stride35_v2 \
  --batch_size=8 \
  --num_workers=2 \
  --steps=167589 \
  --log_freq=100 \
  ...
  --policy.scheduler_decay_steps=167589 \
  --wandb.enable=true \
  --wandb.project=smolvla-erase-shape \
  --wandb.run_id=smolvla_hamlet_pickup_prompt_315_stride35_v2 \
  --wandb.disable_artifact=true

echo "[DONE] smolvla_hamlet_pickup_prompt_315_stride35_v2 완료."

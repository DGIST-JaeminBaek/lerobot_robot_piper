...
"""episodes.csv → 조건별 성능 표 (Q1 논문에 그대로 들어가는 형태).
    ...
    python scripts/tasks/erase_shape/evaluation/eval_kit/summarize.py
    python scripts/tasks/erase_shape/evaluation/eval_kit/summarize.py --csv outputs/analysis/episodes.csv --markdown

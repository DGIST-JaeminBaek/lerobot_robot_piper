...
왜 이걸 재는가 — `docs/tasks/erase_shape/runtime/erase_run_design.md` §4.2는 판정을 **시도 경계**에서만 할 수
...
사용:
    python retreat_analysis.py 'records/outlier/0802_joint4_incorrect/erase_the_*'  --csv out.csv --plot out.png
"""

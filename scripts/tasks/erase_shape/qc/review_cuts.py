...
visible as a gap between the red and green line.
    ...
    python review_cuts.py                     # the episodes that disagree
    python review_cuts.py --all               # every episode in the manifest
    python review_cuts.py --episode 0726-162803 0727-125938

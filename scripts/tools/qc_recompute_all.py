...
실행:
    python scripts/tools/qc_recompute_all.py --sessions 0805 --output /tmp/x.json
    python scripts/tools/qc_recompute_all.py   # 8개 세션 전체
"""
...
def main() -> None:
    ...
    payload = {
        "format_version": 1,
        "generated_by": "scripts/tools/qc_recompute_all.py",

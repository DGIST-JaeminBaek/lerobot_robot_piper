...
사용 예:
    python scripts/piper/recording/smooth_start_frames.py records/local/piper_write_light
    python scripts/piper/recording/smooth_start_frames.py <dataset_root> --num-frames 100 --dry-run
"""

...
usage:
  # 팔을 파킹 자세에 둔 상태로 실행
  python check_zero_reference.py --datasets ~/UGRP/0802 --port can_follower
  python check_zero_reference.py --datasets ~/UGRP/0802 --port can_leader --leader
"""
...
def main() -> None:
    ...
    p.add_argument("--port", default="can_follower")

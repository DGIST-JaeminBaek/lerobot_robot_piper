...
왜 새로 만들었나 — scripts/piper/validation/piper_replay_player.py는 "데이터셋 1개 안의
...
사용 예:
    python scripts/piper/validation/batch_replay_review/batch_replay_review.py            # 기본 두 폴더
    python scripts/piper/validation/batch_replay_review/batch_replay_review.py --resume   # 미판정만
    python scripts/piper/validation/batch_replay_review/batch_replay_review.py --summary  # 진행률만 출력
    python scripts/piper/validation/batch_replay_review/batch_replay_review.py \
...
# piper_replay_player는 패키지가 아니라 scripts/piper/validation 밑의 단독 스크립트라
...
DEFAULT_REVIEW_CSV = "outputs/analysis/replay_review/batch_review.csv"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--window-name", default="Batch replay review")
    ...
    robot.add_argument("--replay-script",
                       default="scripts/piper/validation/batch_replay_review/replay_one_on_robot.sh",

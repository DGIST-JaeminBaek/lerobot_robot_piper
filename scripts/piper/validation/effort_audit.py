...
전체 분포가 필요하다.
  ...
  python scripts/piper/validation/effort_audit.py records/local
  python scripts/piper/validation/effort_audit.py records --limit 8.0
  python scripts/piper/validation/effort_audit.py --selftest
